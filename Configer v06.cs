...
namespace Config
{
    ...
    public class MyConfig
    {
        ...
        public ushort LightsEquipID;
        public ushort SubShades;        //Has Shades
        public ushort ShadesEquipID;
        public ushort SubHVAC;          //Has HVAC
        public ushort HVACEquipID;
        ...
        private static string DaString;
        private Configuration Obj;
        private static SourceList MysList;
...
#region Functions
        ...
        public void Builder(ushort ConnectTo)
        {
            ...
            LightsEquipID = Obj.Rooms[ConnectTo].Lights.LightEquipmentID;
            SubShades = Obj.Rooms[ConnectTo].Shades.isUsing;
            ShadesEquipID = Obj.Rooms[ConnectTo].Shades.ShadeEquipmentID;
            SubHVAC = Obj.Rooms[ConnectTo].HVAC.isUsing;
            HVACEquipID = Obj.Rooms[ConnectTo].HVAC.HVACEquipmentID;
            //debug
...
//v2 Get info about Source X then send data 
        public static void SourceInfo()
        {
            MysList = JsonConvert.DeserializeObject<SourceList>(DaString);
        }

        public static string SourceName(ushort ConnectTo)
        {
            return MysList.ListOfSources[ConnectTo].Name;
        }

        public static ushort SourceEquipID(ushort ConnectTo)
        {
            return MysList.ListOfSources[ConnectTo].EquipID;
        }

        public static ushort SourceSubPageType(ushort ConnectTo)
        {
            return MysList.ListOfSources[ConnectTo].Type;
        }

        public static ushort SourceAudioInput(ushort ConnectTo)
        {
            return MysList.ListOfSources[ConnectTo].Ainput;
        }

        public static ushort SourceVideoInput(ushort ConnectTo)
        {
